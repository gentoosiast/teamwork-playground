...
export class RegForm extends Control<HTMLFormElement> {
  constructor(parent: HTMLElement) {
    ...
    const fieldSet = new Control<HTMLFieldSetElement>(
      this.el,
      "fieldset",
      "flex flex-col"
    );

    const email = new Control<HTMLInputElement>(
      fieldSet.el,
      "input",
      "border-2 rounded-md border-emerald-400 outline-0"
    );
    email.el.type = "email";
    email.el.name = "email";
    email.el.id = "email";
    email.el.required = true;
    const labelEmail = new Control<HTMLLabelElement>(
      fieldSet.el,
      "label",
      "pb-5",
      "Your email"
    ...
    const age = new Control<HTMLInputElement>(
      fieldSet.el,
      "input",
      "border-2 rounded-md border-emerald-400 outline-0"
    );
    ...
    age.el.name = "age";
    age.el.id = "age";
    const labelage = new Control<HTMLLabelElement>(
      fieldSet.el,
      "label",
      "pb-5",
      "Your age"
    ...
    const btn = new Control<HTMLInputElement>(
      fieldSet.el,
      "input",
      "p-2 text-zinc-50 border-2 rounded-md bg-emerald-400 hover:bg-emerald-600 focus:bg-emerald-600",
      "Submit"
    );
    btn.el.type = "submit";
    // BAD PRACTICE, should use onSubmit() and e.preventDefault()
